...
BROWN = (170, 85, 0)
OLIVE_BROWN = (128, 128, 0) # u g l y
RECESSED_BROWN = (120, 100, 80)
LIGHT_BROWN = (180, 160, 140)
AUBURN_BROWN = (130, 82, 40)
WALNUT_BROWN = (101, 67, 33)
...
DIALOGUE_AREA_HEIGHT = 550  # Increased from 400 to 550 for better text wrapping
...
TILESETS_PATH = os.path.join(TILES_PATH, "tilesets")
