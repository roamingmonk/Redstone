...
class GameController:
    ...
    def _initialize_core_dependencies(self):
        ...
        self.dialogue_engine = initialize_dialogue_engine(self.game_state, self.event_manager, self.data_manager.item_manager)
        ...
        # Step 8: Act II Transition Manager (requires: EventManager, GameState)
        self._validate_dependency("event_manager", self.event_manager)

        self.act_two_manager = get_act_two_manager(
            self.event_manager,
            self.game_state
        )
