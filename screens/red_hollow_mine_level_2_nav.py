"""
Red Hollow Mine - Level 2 Navigation
Deeper shafts with branching paths and Meredith's ring
"""
...
from data.maps.red_hollow_mine_level_2_map import (
    MINE_L2_WIDTH,
    MINE_L2_HEIGHT,
    MINE_L2_SPAWN_X,
    MINE_L2_SPAWN_Y,
    MINE_L2_SPAWN_POINTS,
    get_tile_type,
    is_walkable,
    get_tile_color,
    get_transition_info,
...
from data.maps.red_hollow_mine_level_1_map import MINE_L1_SPAWN_POINTS  
from data.maps.red_hollow_mine_level_3_map import MINE_L3_SPAWN_POINTS  
from data.maps.red_hollow_mine_level_2b_map import MINE_L2B_SPAWN_POINTS  

class RedHollowMineLevel2Nav:
    """Navigation screen for mine level 2 with branching paths"""

    def __init__(self):
        config = {
            'map_width': MINE_L2_WIDTH,
            'map_height': MINE_L2_HEIGHT,
            'location_id': 'red_hollow_mine_level_2',
            'map_functions': {
    ...
    def update_player_position(self, game_state):
        ...
        if hasattr(game_state, 'mine_l2_spawn_override_x'):
            game_state.mine_l2_x = game_state.mine_l2_spawn_override_x
            game_state.mine_l2_y = game_state.mine_l2_spawn_override_y
            delattr(game_state, 'mine_l2_spawn_override_x')
            delattr(game_state, 'mine_l2_spawn_override_y')
            print(f"✅ Level 2 spawn override: ({game_state.mine_l2_x}, {game_state.mine_l2_y})")
        elif not hasattr(game_state, 'mine_l2_x'):
            game_state.mine_l2_x = MINE_L2_SPAWN_X
            game_state.mine_l2_y = MINE_L2_SPAWN_Y

        self.renderer.update_camera(game_state.mine_l2_x, game_state.mine_l2_y)
    ...
    def update(self, dt, keys, game_state, controller=None):
        ...
        # Handle movement
        old_x = game_state.mine_l2_x
        old_y = game_state.mine_l2_y
            ...
            if combat_trigger and combat_trigger.get('repeatable'):
                ...
                if random.random() < chance:
                    if controller:
                        ...
                        game_state.previous_screen = 'red_hollow_mine_level_2_nav'
                        game_state.pre_combat_location = 'red_hollow_mine_level_2_nav'  
                        ...
                        controller.event_manager.emit("SCREEN_CHANGE", {
                            ...
                            "source_screen": "red_hollow_mine_level_2_nav"
                        })
                    return

            game_state.mine_l2_x = new_x
            game_state.mine_l2_y = new_y
        ...
        if keys[pygame.K_RETURN] and not self.showing_message:
            player_x = game_state.mine_l2_x
            player_y = game_state.mine_l2_y
            ...
            if transition_info and transition_info[0]:
                if controller:
                    ...
                    if target == 'red_hollow_mine_level_1_nav':
                        spawn_point = MINE_L1_SPAWN_POINTS['from_level_2']
                        game_state.mine_l1_spawn_override_x = spawn_point[0]
                        game_state.mine_l1_spawn_override_y = spawn_point[1]
                    elif target == 'red_hollow_mine_level_3_nav':
                        spawn_point = MINE_L3_SPAWN_POINTS['from_level_2']
                        game_state.mine_l3_spawn_override_x = spawn_point[0]
                        game_state.mine_l3_spawn_override_y = spawn_point[1]
                    elif target == 'red_hollow_mine_level_2b_nav':
                        spawn_point = MINE_L2B_SPAWN_POINTS['from_level_2']
                        game_state.mine_l2b_spawn_override_x = spawn_point[0]
                        game_state.mine_l2b_spawn_override_y = spawn_point[1]
            ...
            if searchable_info:
                ...
                if flag_set and getattr(game_state, flag_set, False):
                    ...
                    if examine_dialogue and controller:
                        ...
                        setattr(game_state, return_screen_attr, 'red_hollow_mine_level_2_nav')
    ...
    def render(self, surface, fonts, images, game_state):
        ...
        title_text = "RED HOLLOW MINE - LEVEL 2"
...
_mine_level_2_instance = None

def draw_red_hollow_mine_level_2_nav(surface, game_state, fonts, images, controller=None):
    """ScreenManager integration function"""
    global _mine_level_2_instance

    if _mine_level_2_instance is None:
        _mine_level_2_instance = RedHollowMineLevel2Nav()

    if hasattr(pygame, 'key') and pygame.get_init():
        keys = pygame.key.get_pressed()
        dt = 16
        _mine_level_2_instance.update(dt, keys, game_state, controller)

    return _mine_level_2_instance.render(surface, fonts, images, game_state)