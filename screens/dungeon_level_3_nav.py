...
class DungeonLevel3Nav:
    """Navigation screen for dungeon level 3 - The Convergence"""
    ...
    def __init__(self):
        ...
        try:
            self.tilemap = load_tiled_map_with_names(
                'dungeon_level_3_tiles',  # TMJ filename (without extension)
                'dungeon',
                DUNGEON_TILE_MAP,
                TILESETS_PATH
            )
            ...
            self.tilemap = {
                'width': DUNGEON_L3_WIDTH,
                'height': DUNGEON_L3_HEIGHT,
                'tile_grid': None
            }
        ...
        config = {
            ...
            'spawn_position': (DUNGEON_L3_SPAWN_X, DUNGEON_L3_SPAWN_Y),
    ...
    def update_player_position(self, game_state):
        ...
        if hasattr(game_state, 'dungeon_l3_spawn_override_x'):
            ...
            if getattr(game_state, 'using_mine_tunnel_entrance', False):
                ...
                spawn_point = DUNGEON_L3_SPAWN_POINTS['from_mine_tunnel']
                game_state.dungeon_l3_x = spawn_point[0]
                game_state.dungeon_l3_y = spawn_point[1]
                print(f"🏛️ Entered Dungeon Level 3 via MINE TUNNEL at {spawn_point}")
            else:
    ...
    def update(self, dt, keys, game_state, controller=None):
        ...
        if new_x != old_x or new_y != old_y:
            ...
            if combat_trigger:
                ...
                # Trigger combat
                if controller:
                    game_state.previous_screen = 'dungeon_level_3_nav'
                    game_state.pre_combat_location = 'dungeon_level_3_nav'
    ...
    def render(self, surface, fonts, images, game_state):
        ...
        # Cult warning subtitle (UNIQUE TO LEVEL 3)
