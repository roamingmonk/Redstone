...
class SwampChurchExteriorNav:
            ...
            if searchable_info:
                ...
                if flag_set and getattr(game_state, flag_set, False):
                    ...
                    if examine_dialogue and controller:
                        # Extract npc_id from dialogue screen name (e.g., "swamp_church_graves" -> "graves")
                        ...
                        setattr(game_state, return_screen_attr, 'swamp_church_exterior_nav')
    ...
    def _trigger_loot_check(self, loot_table_id, game_state, controller):
        ...
        location_file = os.path.join(LOCATION_DATA_PATH, "swamp_church.json")
        ...
        with open(location_file, 'r') as f:
            ...
            location_data = location_full_data.get('swamp_church', location_full_data)
...
_swamp_church_exterior_nav_instance = None

def draw_swamp_church_exterior_nav(surface, game_state, fonts, images, controller=None):
    """ScreenManager integration function"""
    global _swamp_church_exterior_nav_instance
    
    if _swamp_church_exterior_nav_instance is None:
        _swamp_church_exterior_nav_instance = SwampChurchExteriorNav()
