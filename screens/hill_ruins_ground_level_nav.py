"""
Hill Ruins Ground Level Navigation
Scrollable tile-based exploration screen for interior ruins
"""
...
from data.maps.hill_ruins_ground_level_map import (
    HILL_RUINS_GL_WIDTH,
    HILL_RUINS_GL_HEIGHT,
    HILL_RUINS_GL_SPAWN_X,
    HILL_RUINS_GL_SPAWN_Y,
    get_tile_type,
    is_walkable,
    get_tile_color,
...
class HillRuinsGroundLevelNav:
    """Navigation screen for hill ruins ground level exploration"""
    ...
    def update_player_position(self, game_state):
        ...
        if not hasattr(game_state, 'hill_ruins_ground_level_x'):
            game_state.hill_ruins_ground_level_x = HILL_RUINS_GL_SPAWN_X
            game_state.hill_ruins_ground_level_y = HILL_RUINS_GL_SPAWN_Y
        
        self.renderer.update_camera(
            game_state.hill_ruins_ground_level_x, 
            game_state.hill_ruins_ground_level_y
        )
    ...
    def update(self, dt, keys, game_state, controller=None):
        ...
        # Handle movement
        old_x = game_state.hill_ruins_ground_level_x
        old_y = game_state.hill_ruins_ground_level_y
                ...
                if roll < chance:
                    ...
                    if controller:
                        ...
                        controller.event_manager.emit("SCREEN_CHANGE", {
                            ...
                            "source_screen": "hill_ruins_ground_level_nav"
                        })
                    return  # Don't move yet, combat starting
            
            # No combat (or failed chance roll), update position
            game_state.hill_ruins_ground_level_x = new_x
            game_state.hill_ruins_ground_level_y = new_y
        ...
        if (self.renderer.check_enter_just_pressed(keys) and 
            ...
            player_x = game_state.hill_ruins_ground_level_x
            player_y = game_state.hill_ruins_ground_level_y
            ...
            if searchable_info:
                ...
                if flag_set and getattr(game_state, flag_set, False):
                    ...
                    if examine_dialogue and controller:
                        ...
                        setattr(game_state, return_screen_attr, 'hill_ruins_ground_level_nav')
    ...
    def render(self, surface, fonts, images, game_state):
        """Render the ground level navigation screen"""
        surface.fill(BLACK)
        ...
        title_text = "THE RUINS ON THE HILL - GROUND LEVEL"
...
_hill_ruins_ground_level_nav_instance = None

def draw_hill_ruins_ground_level_nav(surface, game_state, fonts, images, controller=None):
    """ScreenManager integration function"""
    global _hill_ruins_ground_level_nav_instance
    
    if _hill_ruins_ground_level_nav_instance is None:
        _hill_ruins_ground_level_nav_instance = HillRuinsGroundLevelNav()
